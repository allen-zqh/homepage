...
The site presents research interests, news, education, publications, employment history, and academic service. It is a lightweight static website designed for deployment with GitHub Pages.
...
The original version was forked from Yan Xia's homepage and drew inspiration from the academic websites of Jon Barron, Zehong Shen, Huaijin Pi, and Geng Chen. The current layout and visual system have since been substantially redesigned.
